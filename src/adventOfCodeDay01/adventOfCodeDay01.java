...
public class adventOfCodeDay01 {
    public static void adventOfCodePart01() throws IOException {
        ...
        String filePath = "C:\\Users\\Furkan\\Desktop\\AdventofCode\\Advent-of-Code\\src\\adventOfCodeDay01\\advent01";
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            System.out.println("Total sum for adventOfCodeDay01 Part1 Challange : " +totalSum);
        }
    }
}
